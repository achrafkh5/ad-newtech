...
export default function Navbar() {
  ...
  return (
    <nav className="sticky top-0 z-50 bg-white/90 dark:bg-[#1A1D1A]/90 backdrop-blur-md shadow-md transition-all duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 sm:py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-2 lg:gap-4">
            {/* Language Switcher */}
            <div className="flex items-center gap-1 bg-[#F0F5F1] dark:bg-[#2D6A4F]/20 rounded-full p-1">
              <button
            ...
            <div className="flex items-center gap-1 bg-[#F0F5F1] dark:bg-[#2D6A4F]/20 rounded-full p-1">
              <button
                ...
                className={`p-1.5 lg:p-2 rounded-full text-sm font-medium transition-all ${
                  mounted && theme === 'light'
                    ? 'bg-[#2D6A4F] text-white shadow-md'
                    : 'text-[#2D6A4F] dark:text-[#CAD2C5] hover:bg-[#CAD2C5]/30'
                }`}
          ...
          <button
            ...
            className="md:hidden p-2 rounded-lg text-[#2D6A4F] dark:text-[#CAD2C5] hover:bg-[#F0F5F1] dark:hover:bg-[#2D6A4F]/20 transition-colors"
        ...
        {mobileMenuOpen && (
          <div className="md:hidden mt-4 pb-4 border-t border-gray-200 dark:border-gray-700 pt-4">
            ...
            <div className="flex flex-col space-y-3 mb-4">
              <Link 
                href="/" 
                className="text-[#1A1D1A] dark:text-white hover:text-[#2D6A4F] dark:hover:text-[#FFB703] font-medium transition-colors px-2 py-1" 
                suppressHydrationWarning
